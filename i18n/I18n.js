...
var messages = {
  en: {
    ...
    chooseSourceTooltip: "Choose what to mirror",
    ...
    sourceHint: "Use the monitor icon to choose a screen or window. Start uses the last source.",
  ...
  nb: {
    ...
    chooseSourceTooltip: "Velg hva som skal speiles",
    ...
    sourceHint: "Bruk skjermikonet for å velge skjerm eller vindu. Start bruker forrige kilde.",
